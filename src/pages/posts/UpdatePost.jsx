...
const UpdatePost = () => {
    ...
    // 일반적으로 useParams 가져올 값은 숫자 or 영어 cuz 한글 가져올 시 깨져서 전달 될 가능성이 있다.
    ...
    const handleUpdate = () => {
        const updateContent = {
            // userId 는  추후 login 한 세션에서 가져와 넣을 예정
            // 현재 postStatus 는 설정해놓은 변수 이름이 없기 때문에 "XX" 라는 값으로 임의 설정
// controller DTO 명칭 : react 에서 작성한 명칭
        ...
        apiService.updatePost(
            postId, updateContent, "수정 성공", "백엔드 에러"
        )
