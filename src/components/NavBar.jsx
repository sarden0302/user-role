                    ...
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <ul className="dropdown-menu">
                                <li><Link className="dropdown-item" to="/posts">게시글 목록</Link></li>
                                <li>
                                ...
                                <li>
                                    <li><Link className="dropdown-item" to="/posts/create">게시글 작성</Link></li>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <ul className="dropdown-menu">
                                <li><Link className="dropdown-item" to="/clothes">의류 목록</Link></li>
                                <li><Link className="dropdown-item" to="/clothes/add">의류 추가</Link></li>
                                <li>
                                    <hr className="dropdown-divider"/>
                                </li>
                        ...
                        {user?.role === 3 && (
                            <li className="nav-item">
                                <Link className="nav-link" to="/user">유저 페이지</Link>
                            </li>
                        )}
